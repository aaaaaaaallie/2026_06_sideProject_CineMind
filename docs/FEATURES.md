...
- AI 以中立影評人 persona 回應：語氣冷靜、優缺點並陳，會補充被忽略的面向、指出站不住腳的論點，但不嘲諷也不一味附和。「中立」指語氣與態度，不是不表態——prompt 明令禁止「各有優缺點」「因人而異」這類打太極的說法。persona 會帶入 OMDb 的劇情/導演/主演資料，即使是訓練資料 cutoff 之後上映的新片，AI 也能就事實討論而非坦承不知道。
